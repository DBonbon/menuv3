...
from ..models import Menu, CompanyLogo, HomePage
...
def load_home_page_menu(context):
    return context['request'].site.root_page.get_children().live().in_menu()
...
@register.inclusion_tag('blog/top_menu.html', takes_context=True)
...
@register.inclusion_tag('blog/top_menu_children.html', takes_context=True)
